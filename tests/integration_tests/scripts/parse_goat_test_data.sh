...
genomehubs parse \
    --ncbi-datasets-genome tests/integration_tests/data/assembly-data-sample/eukaryota \
    --outfile tests/integration_tests/data/assembly-data-genome/ncbi_datasets.tsv &&
genomehubs parse \
...
genomehubs index \
    --config-file tests/integration_tests/config/goat.yaml \
    --taxonomy-source ncbi \
    --assembly-dir tests/integration_tests/data/assembly-data-genome &&
# genomehubs index \
#     --config-file tests/integration_tests/config/goat.yaml \
#     --taxonomy-source ncbi \
