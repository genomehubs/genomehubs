...
export const ContainedByFeatureTemplate = ({
  featureId,
  featureType = "*",
  sequenceId,
  taxonomy,
}) => {
  let id = `featureContainedByFeatureId`;
  let title = `Feature contained by feature ID`;
  let description = "Find features contained by a given feature ID";
  let props = {
...
export default ContainedByFeatureTemplate;
